...
class ImageFlecheAScreen extends StatefulWidget {
  ...
  @override
  State<ImageFlecheAScreen> createState() => _ImageFlecheAScreenState();
}

class _ImageFlecheAScreenState extends State<ImageFlecheAScreen> {
  late Uint8List imageFlecheA;
          ...
          RepaintBoundary(
            ...
            child: Stack(
              children: [
                Positioned.fill(
                  child: Image.asset(
                    "assets/images/chocInitialImageA.png",
                  ),
                ),
                GestureDetector(
                  onPanStart: (details) {},
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    imageFlecheA = await generateImage();

                    widget.pdfConstatModel.imageFlecheA = imageFlecheA;

                    Navigator.pushNamed(context, '/resumeA',
