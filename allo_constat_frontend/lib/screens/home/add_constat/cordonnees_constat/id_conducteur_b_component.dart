...
class IdConducteurBComponent extends StatefulWidget {
  final ValueNotifier<ConstatState> constatNotifier;
  final PDFConstatModel pdfConstatModel;
  const IdConducteurBComponent({
    required GlobalKey<IdConducteurBComponentState> key,
    required this.constatNotifier,
    required this.pdfConstatModel,
  }) : super(key: key);

  @override
  State<IdConducteurBComponent> createState() => IdConducteurBComponentState();
}

class IdConducteurBComponentState extends State<IdConducteurBComponent> {
  ...
  Future<void> remplir() async {
    widget.pdfConstatModel.nomConducteurB = _nomConducteur.text.trim();
    widget.pdfConstatModel.prenomConducteurB = _prenomConducteur.text.trim();
    widget.pdfConstatModel.adresseConducteurB = _adresseConducteur.text.trim();
    widget.pdfConstatModel.permisConduireConducteurB =
        _permisConduireConducteur.text.trim();
    widget.pdfConstatModel.delivreConducteurB = delivre;
  }
