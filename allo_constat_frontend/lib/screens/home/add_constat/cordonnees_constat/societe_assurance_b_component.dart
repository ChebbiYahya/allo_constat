...
class SocieteAssuranceBComponent extends StatefulWidget {
  final ValueNotifier<ConstatState> constatNotifier;
  final PDFConstatModel pdfConstatModel;
  const SocieteAssuranceBComponent({
    required GlobalKey<SocieteAssuranceBComponentState> key,
    required this.constatNotifier,
    required this.pdfConstatModel,
  }) : super(key: key);

  @override
  State<SocieteAssuranceBComponent> createState() =>
      SocieteAssuranceBComponentState();
}

class SocieteAssuranceBComponentState
    extends State<SocieteAssuranceBComponent> {
  ...
  Future<void> remplir() async {
    widget.pdfConstatModel.vehiculeAssureParB = _vehiculeAssurePar.text.trim();
    widget.pdfConstatModel.policeAssuranceB = _policeAssurance.text.trim();
    widget.pdfConstatModel.agenceB = _agence.text.trim();
    widget.pdfConstatModel.attestationValableDeB = attestationDu;
    widget.pdfConstatModel.attestationValableAuB = attestationAu;
  }
