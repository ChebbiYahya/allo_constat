...
class ImagesCarteBComponent extends StatefulWidget {
  final ValueNotifier<ConstatState> constatNotifier;
  final PDFConstatModel pdfConstatModel;
  const ImagesCarteBComponent({
    required GlobalKey<ImagesCarteBComponentState> key,
    required this.constatNotifier,
    required this.pdfConstatModel,
  }) : super(key: key);

  @override
  State<ImagesCarteBComponent> createState() => ImagesCarteBComponentState();
}

class ImagesCarteBComponentState extends State<ImagesCarteBComponent> {
  ...
  Future<void> remplir() async {
    widget.pdfConstatModel.imageCarteGriseRectoB = _imageCartegrisePhase;
    widget.pdfConstatModel.imageCarteGriseVersoB = _imageCartegriseVerso;
    widget.pdfConstatModel.imageAssuranceB = _imageAssurance;
    widget.pdfConstatModel.imagePermisRectoB = _imagePermisPhase;
    widget.pdfConstatModel.imagePermisVersoB = _imagePermisVerso;
  }
