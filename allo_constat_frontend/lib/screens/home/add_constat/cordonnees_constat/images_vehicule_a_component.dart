...
class ImagesVehiculeAComponent extends StatefulWidget {
  final ValueNotifier<ConstatState> constatNotifier;
  final PDFConstatModel pdfConstatModel;
  const ImagesVehiculeAComponent({
    required GlobalKey<ImagesVehiculeAComponentState> key,
    required this.constatNotifier,
    required this.pdfConstatModel,
  }) : super(key: key);

  @override
  State<ImagesVehiculeAComponent> createState() =>
      ImagesVehiculeAComponentState();
}

class ImagesVehiculeAComponentState extends State<ImagesVehiculeAComponent> {
  ...
  Future<void> remplir() async {
    widget.pdfConstatModel.imageVoitureAvA = _imageVehAvant;
    widget.pdfConstatModel.imageVoitureAvDA = _imageVehAvantDroit;
    widget.pdfConstatModel.imageVoitureAvGA = _imageVehAvantGauche;
    widget.pdfConstatModel.imageVoitureDA = _imageVehDroit;
    widget.pdfConstatModel.imageVoitureGA = _imageVehGauche;
    widget.pdfConstatModel.imageVoitureDerA = _imageVehDerriere;
    widget.pdfConstatModel.imageVoitureDerDA = _imageVehDerriereDroit;
    widget.pdfConstatModel.imageVoitureDerGA = _imageVehDerriereGauche;
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            const TitleConstat(nb: "17", title: "Vehicule A"),
            Text(
